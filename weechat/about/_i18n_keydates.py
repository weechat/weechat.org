...
def __i18n_about_keydates():
    ...
    gettext_noop("Integration of secured data with external password manager, add edition of filters.")
    ...
    gettext_noop("Opt-in option to download scripts from weechat.org.")
