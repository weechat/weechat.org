...
def __i18n_about_keydates():
    ...
    gettext_noop("Add builtin theme feature with default dark and light themes, improve speed of /upgrade command.")
    ...
    gettext_noop("Add command /pipe, add key Ctrl+Alt+l (L) to toggle between remote and local commands on remote buffers (api relay), add completion resource in api relay.")
    ...
    gettext_noop("Add option typing.look.item_text, add option `-e` in command /eval, evaluate option xfer.network.own_ip.")
