...
def __i18n_scripts_scripts():
    ...
    gettext_noop("Adds random capitalization to your sentence.")
    ...
    # Translators: description for script "censor.py" (0.3.0+)
    gettext_noop("Censor messages by nick and text using color while still logging them.")
    ...
    gettext_noop("Convert emoji shortcodes to unicode.")
    ...
    # Translators: description for script "tennis.py" (4.1.0+)
    gettext_noop("Live tennis scores and ATP/WTA rankings on demand.")
    ...
    gettext_noop("Make messages more A E S T H E T I C A L L Y pleasing.")
    ...
    # Translators: description for script "qr_code.py" (0.3.0+)
    gettext_noop("QR code generator.")
    ...
    gettext_noop("Replace emoji characters with ascii text and vice versa.")
    ...
    gettext_noop("Retrieve information about an IP address.")
    ...
    gettext_noop("Set least privilege on OpenBSD.")
    # Translators: description for script "weefusables.py" (0.3.0+)
    gettext_noop("Set message tag when confusables chars are used in words.")
    ...
    # Translators: description for script "irc_react_inline.py" (0.3.0+)
    gettext_noop("Show IRCv3 draft/react reactions inline on the original message.")
    ...
    gettext_noop("Support of draft/read-marker IRC extension.")
